...
public class OPigTuskLayer extends GeoLayerRenderer<OPig> {
    public OPigTuskLayer(IGeoRenderer entityRendererIn) {
    ...
    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, OPig entityLivingBaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        RenderType renderType = RenderType.entityCutout(((OPig)entityLivingBaseIn).getTusksLocation());
    ...
    public enum Overlay {
        FEMALE(new ResourceLocation(LivestockOverhaul.MODID, "textures/entity/pig/overlay/none.png")),
        MALE(new ResourceLocation(LivestockOverhaul.MODID, "textures/entity/pig/overlay/pig_tusks.png"));
