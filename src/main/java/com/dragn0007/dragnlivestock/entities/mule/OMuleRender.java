...
public class OMuleRender extends ExtendedGeoEntityRenderer<OMule> {
    ...
    @Nullable
    @Override
    public ResourceLocation getTextureForBone(String boneName, OMule animatable) {
        return null;
    }

    @Nullable
    @Override
    public ItemStack getHeldItemForBone(String boneName, OMule animatable) {
        return null;
    }
    ...
    @Nullable
    @Override
    public BlockState getHeldBlockForBone(String boneName, OMule animatable) {
        return null;
    }

    @Override
    public void preRenderItem(PoseStack poseStack, ItemStack stack, String boneName, OMule animatable, IBone bone) {
    }

    @Override
    public void preRenderBlock(PoseStack poseStack, BlockState state, String boneName, OMule animatable) {
    }

    @Override
    public void postRenderItem(PoseStack poseStack, ItemStack stack, String boneName, OMule animatable, IBone bone) {
    }

    @Override
    public void postRenderBlock(PoseStack poseStack, BlockState state, String boneName, OMule animatable) {
    }
}
