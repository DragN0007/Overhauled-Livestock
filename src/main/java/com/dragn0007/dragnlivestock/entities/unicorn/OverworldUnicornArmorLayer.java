...
@OnlyIn(Dist.CLIENT)
public class OverworldUnicornArmorLayer extends GeoLayerRenderer<OverworldUnicorn> {
    public OverworldUnicornArmorLayer(IGeoRenderer<OverworldUnicorn> entityRendererIn) {
