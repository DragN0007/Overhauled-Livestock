...
public class OverworldUnicornRender extends ExtendedGeoEntityRenderer<OverworldUnicorn> {
    ...
    public OverworldUnicornRender(EntityRendererProvider.Context renderManager) {
        ...
        this.addLayer(new OverworldUnicornCarpetLayer(this));
    ...
    @Nullable
    @Override
    public ResourceLocation getTextureForBone(String boneName, OverworldUnicorn animatable) {
        return null;
    }

    @Nullable
    @Override
    public ItemStack getHeldItemForBone(String boneName, OverworldUnicorn animatable) {
        return null;
    }
    ...
    @Nullable
    @Override
    public BlockState getHeldBlockForBone(String boneName, OverworldUnicorn animatable) {
        return null;
    }

    @Override
    public void preRenderItem(PoseStack poseStack, ItemStack stack, String boneName, OverworldUnicorn animatable, IBone bone) {
    }

    @Override
    public void preRenderBlock(PoseStack poseStack, BlockState state, String boneName, OverworldUnicorn animatable) {
    }

    @Override
    public void postRenderItem(PoseStack poseStack, ItemStack stack, String boneName, OverworldUnicorn animatable, IBone bone) {
    }

    @Override
    public void postRenderBlock(PoseStack poseStack, BlockState state, String boneName, OverworldUnicorn animatable) {
    }
}
