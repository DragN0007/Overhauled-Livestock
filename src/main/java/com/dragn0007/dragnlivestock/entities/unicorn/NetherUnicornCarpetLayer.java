...
@OnlyIn(Dist.CLIENT)
public class NetherUnicornCarpetLayer extends GeoLayerRenderer<NetherUnicorn> {
    ...
    public NetherUnicornCarpetLayer(IGeoRenderer<NetherUnicorn> entityRendererIn) {
