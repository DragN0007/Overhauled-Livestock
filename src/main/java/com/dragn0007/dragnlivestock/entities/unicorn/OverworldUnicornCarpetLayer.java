...
@OnlyIn(Dist.CLIENT)
public class OverworldUnicornCarpetLayer extends GeoLayerRenderer<OverworldUnicorn> {
    ...
    public OverworldUnicornCarpetLayer(IGeoRenderer<OverworldUnicorn> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, OverworldUnicorn entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
