...
@OnlyIn(Dist.CLIENT)
public class EndUnicornCarpetLayer extends GeoLayerRenderer<EndUnicorn> {
    ...
    public EndUnicornCarpetLayer(IGeoRenderer<EndUnicorn> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, EndUnicorn entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
