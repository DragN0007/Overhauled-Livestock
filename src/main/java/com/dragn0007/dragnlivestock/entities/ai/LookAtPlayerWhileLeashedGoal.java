...
public class LookAtPlayerWhileLeashedGoal extends Goal {
   ...
   public LookAtPlayerWhileLeashedGoal(Mob p_25524_, Class<? extends LivingEntity> p_25525_, float p_25526_, float p_25527_) {
      this(p_25524_, p_25525_, p_25526_, p_25527_, false);
   }

   public LookAtPlayerWhileLeashedGoal(Mob p_148118_, Class<? extends LivingEntity> p_148119_, float p_148120_, float p_148121_, boolean p_148122_) {
      this.mob = p_148118_;
   ...
   public boolean canUse() {
      if (this.mob.getRandom().nextFloat() >= this.probability && mob.isLeashed()) {
         return false;
      } else {
