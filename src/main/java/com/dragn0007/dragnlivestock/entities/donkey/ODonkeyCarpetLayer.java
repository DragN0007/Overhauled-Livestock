...
@OnlyIn(Dist.CLIENT)
public class ODonkeyCarpetLayer extends GeoLayerRenderer<ODonkey> {
    ...
    public ODonkeyCarpetLayer(IGeoRenderer<ODonkey> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn, ODonkey entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
